...
*/
/*!
 * \file keyple_status.h.
 *
 * \brief Execution statuses
 */

#ifndef KEYPLE_STATUS_H
#define KEYPLE_STATUS_H
...
typedef enum ExecutionStatus
{
	...
	BAD_PARAMETER_ERROR = 3010,
	INDEX_OUTSIDE_BOUNDARIES = 3011

} ExecutionStatus;

#endif // KEYPLE_STATUS_H